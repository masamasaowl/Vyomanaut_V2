...
func allRegisteredRoutes() []routeFixture {
	return []routeFixture{
		...
		{"GET", "/api/v1/pricing/estimate", authNone, false},
		{"GET", "/api/v1/pricing/provider-estimate", authNone, false},
		{"POST", "/api/v1/owner/register", authBearerAny, false},
		{"POST", "/api/v1/owner/deposit", authBearerOwner, false},
		{"GET", "/api/v1/owner/11111111-1111-1111-1111-111111111111/balance", authBearerOwner, false},
		{"GET", "/api/v1/owner/11111111-1111-1111-1111-111111111111/files", authBearerOwner, false},
		{"GET", "/api/v1/owner/11111111-1111-1111-1111-111111111111/escrow", authBearerOwner, false},
		{"POST", "/api/v1/owner/withdraw", authBearerOwner, false},
		{"POST", "/api/v1/provider/register", authBearerAny, false},
		{"POST", "/api/v1/provider/heartbeat", authBearerProvider, false},
		{"POST", "/api/v1/provider/token/refresh", authNone, true}, // its own two-factor auth, checked inside the handler
		{"GET", "/api/v1/provider/11111111-1111-1111-1111-111111111111/status", authBearerProvider, false},
		{"GET", "/api/v1/provider/receipts", authBearerProvider, false},
		{"POST", "/api/v1/provider/downtime", authBearerProvider, false},
		{"POST", "/api/v1/provider/depart", authBearerProvider, false},
		{"POST", "/api/v1/upload/assign", authBearerOwner, false},
		{"POST", "/api/v1/file/register", authBearerOwner, false},
		{"GET", "/api/v1/file/11111111-1111-1111-1111-111111111111/pointer", authBearerOwner, false},
		{"DELETE", "/api/v1/file/11111111-1111-1111-1111-111111111111", authBearerOwner, false},
